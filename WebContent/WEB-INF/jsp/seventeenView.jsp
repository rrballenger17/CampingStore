...
<br />
<br />
<form action="/CampingStore/services/rest/greeting" method="GET">
...
<form action="/CampingStore/services/rest/comment" method="GET">
	<input type="submit" value ="Send Request" />
</form>
...
<form onsubmit="this.action = this.action + this.commentId.value;" action="/CampingStore/services/rest/comment/" method="GET">
